...
%% basic handler
-module(swag_server_wallet_p2_p_templates_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'BlockP2PTransferTemplate'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CreateP2PTransferTemplate'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CreateP2PTransferWithTemplate'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'GetP2PTransferTemplateByID'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IssueP2PTransferTemplateAccessToken'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'IssueP2PTransferTicket'
    }
) ->
    {[<<"POST">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'QuoteP2PTransferWithTemplate'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'BlockP2PTransferTemplate' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'CreateP2PTransferTemplate' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'CreateP2PTransferWithTemplate' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'GetP2PTransferTemplateByID' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'IssueP2PTransferTemplateAccessToken' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'IssueP2PTransferTicket' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
is_authorized(
    Req0,
    State = #state{
        operation_id  = 'QuoteP2PTransferWithTemplate' = OperationID,
        logic_handler = LogicHandler,
        context       = Context
    }
) ->
...
get_request_spec('BlockP2PTransferTemplate') ->
    [
        {'X-Request-ID', #{
            source => header,
...
get_request_spec('CreateP2PTransferTemplate') ->
    [
        {'X-Request-ID', #{
            source => header,
            rules  => [{type, 'binary'}, {max_length, 32}, {min_length, 1}, true
...
get_request_spec('CreateP2PTransferWithTemplate') ->
    [
        {'X-Request-ID', #{
            source => header,
            rules  => [{type, 'binary'}, {max_length, 32}, {min_length, 1}, true
...
get_request_spec('GetP2PTransferTemplateByID') ->
    [
        {'X-Request-ID', #{
            source => header,
            rules  => [{type, 'binary'}, {max_length, 32}, {min_length, 1}, true
...
get_request_spec('IssueP2PTransferTemplateAccessToken') ->
    [
        {'X-Request-ID', #{
            source => header,
            rules  => [{type, 'binary'}, {max_length, 32}, {min_length, 1}, true
...
get_request_spec('IssueP2PTransferTicket') ->
    [
        {'X-Request-ID', #{
            source => header,
            rules  => [{type, 'binary'}, {max_length, 32}, {min_length, 1}, true
...
get_request_spec('QuoteP2PTransferWithTemplate') ->
    [
        {'X-Request-ID', #{
            source => header,
            rules  => [{type, 'binary'}, {max_length, 32}, {min_length, 1}, true
...
get_response_spec('BlockP2PTransferTemplate', 204) ->
    undefined;

get_response_spec('BlockP2PTransferTemplate', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('BlockP2PTransferTemplate', 401) ->
    undefined;

get_response_spec('BlockP2PTransferTemplate', 404) ->
    undefined;

get_response_spec('BlockP2PTransferTemplate', 422) ->
    {'InvalidOperationParameters', 'InvalidOperationParameters'};

get_response_spec('CreateP2PTransferTemplate', 201) ->
    {'P2PTransferTemplate', 'P2PTransferTemplate'};

get_response_spec('CreateP2PTransferTemplate', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('CreateP2PTransferTemplate', 401) ->
    undefined;

get_response_spec('CreateP2PTransferTemplate', 409) ->
    {'ConflictRequest', 'ConflictRequest'};

get_response_spec('CreateP2PTransferTemplate', 422) ->
    {'InvalidOperationParameters', 'InvalidOperationParameters'};

get_response_spec('CreateP2PTransferWithTemplate', 202) ->
    {'P2PTransfer', 'P2PTransfer'};

get_response_spec('CreateP2PTransferWithTemplate', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('CreateP2PTransferWithTemplate', 401) ->
    undefined;

get_response_spec('CreateP2PTransferWithTemplate', 404) ->
    undefined;

get_response_spec('CreateP2PTransferWithTemplate', 409) ->
    {'ConflictRequest', 'ConflictRequest'};

get_response_spec('CreateP2PTransferWithTemplate', 422) ->
    {'InvalidOperationParameters', 'InvalidOperationParameters'};

get_response_spec('GetP2PTransferTemplateByID', 200) ->
    {'P2PTransferTemplate', 'P2PTransferTemplate'};

get_response_spec('GetP2PTransferTemplateByID', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('GetP2PTransferTemplateByID', 401) ->
    undefined;

get_response_spec('GetP2PTransferTemplateByID', 404) ->
    undefined;

get_response_spec('IssueP2PTransferTemplateAccessToken', 201) ->
    {'P2PTransferTemplateTokenRequest', 'P2PTransferTemplateTokenRequest'};

get_response_spec('IssueP2PTransferTemplateAccessToken', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('IssueP2PTransferTemplateAccessToken', 401) ->
    undefined;

get_response_spec('IssueP2PTransferTemplateAccessToken', 404) ->
    undefined;

get_response_spec('IssueP2PTransferTemplateAccessToken', 422) ->
    {'InvalidOperationParameters', 'InvalidOperationParameters'};

get_response_spec('IssueP2PTransferTicket', 201) ->
    {'P2PTransferTemplateTokenRequest', 'P2PTransferTemplateTokenRequest'};

get_response_spec('IssueP2PTransferTicket', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('IssueP2PTransferTicket', 401) ->
    undefined;

get_response_spec('IssueP2PTransferTicket', 404) ->
    undefined;

get_response_spec('IssueP2PTransferTicket', 422) ->
    {'InvalidOperationParameters', 'InvalidOperationParameters'};

get_response_spec('QuoteP2PTransferWithTemplate', 201) ->
    {'P2PTransferQuote', 'P2PTransferQuote'};

get_response_spec('QuoteP2PTransferWithTemplate', 400) ->
    {'BadRequest', 'BadRequest'};

get_response_spec('QuoteP2PTransferWithTemplate', 401) ->
    undefined;

get_response_spec('QuoteP2PTransferWithTemplate', 404) ->
    undefined;

get_response_spec('QuoteP2PTransferWithTemplate', 422) ->
    {'InvalidOperationParameters', 'InvalidOperationParameters'};
