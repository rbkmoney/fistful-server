...
-spec quote_transfer_fail_resource_token_invalid_test(config()) ->
    _.
...
-spec create_transfer_ok_test(config()) ->
    _.
...
-spec create_transfer_fail_resource_token_invalid_test(config()) ->
    _.
