...
create_wallet_ok(C) ->
    ...
    WalletName  = WalletState2#wlt_Wallet.name,
    unblocked   = WalletState2#wlt_Wallet.blocking,
    ExternalId  = WalletState2#wlt_Wallet.external_id,
    Ctx         = WalletState2#wlt_Wallet.context,
    Account     = WalletState2#wlt_Wallet.account,
