...
-spec authorize_api_key(swag_server_wallet:operation_id(), swag_server_wallet:api_key()) ->
...
-spec handle_request(swag_server_wallet:operation_id(), req_data(), swag_server_wallet:request_context()) ->
    request_result().
handle_request(OperationID, Req, SwagContext) ->
    wapi_handler:handle_request(OperationID, Req, SwagContext, ?MODULE).

-spec process_request(swag_server_wallet:operation_id(), req_data(), handler_context()) ->
    request_result().
